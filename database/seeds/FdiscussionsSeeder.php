...
class FdiscussionsSeeder extends Seeder
{
 ...
 //
        ...
        factory(App\User::class, 5)->create()->each(function ($user) {
            $role1 = Role::findByName('Asesor');
            $user->Asesor()->save(factory(App\Models\Asesor::class)->make());
            $user->assignRole($role1);
        });

        factory(App\User::class, 50)->create()->each(function ($user) {
            $role2 = Role::findByName('Estudiante');
            $user->Estudiante()->save(factory(App\Models\Estudiante::class)->make());
            $user->assignRole($role2);
        });

        Factory(App\Models\Curso::class,50)->create();
        Factory(App\Models\Matriculado::class,500)->create();        
        Factory(App\Models\Activitie::class,2000)->create();
        Factory(App\Models\Contenido::class,50)->create();        
        Factory(App\Models\Work::class,2000)->create();
        Factory(App\Models\Task::class,50)->create();
        Factory(App\Models\Qualification::class,50)->create();

        Factory(App\Models\fcategoria::class,200)->create();       
        Factory(App\Models\fdiscusion::class,1000)->create();
        Factory(App\Models\fpost::class,3000)->create();
        Factory(App\Models\user_fdiscusion::class,1000)->create();
    }
}
