<!--
Swiping to the right side to success

On success this.$emit('control',true);

Component Props

width 		Component width	
height 		Component height
text 		Component inner text
successText	Component inner text on success
background 	Component background
progressBarBg   Component inner bar progress background
completedBg     Component inner bar progress background on success
circle		Component border radius 50%
handlerIcon	Component inner handler icon
successIcon	Component inner handler icon on success
textSize 	Component inner text size
-->
<template>
	<div class="drag_verify" :style="dragVerifyStyle" @mousemove="dragMoving"
	 @mouseup="dragFinish" @touchmove="dragMoving" @touchend="dragFinish" @mouseleave="dragFinish">			
	...
	methods:{
		...
		dragMoving: function(e){
            if(this.isMoving && !this.isPassing){
            	...
            	var handler = this.$refs.handler;
                if(_x > 0 && _x <= (this.width-this.height)*0.9){
                    handler.style.left = _x + 'px';
                    this.$refs.progressBar.style.width = (_x+this.height/2)+'px';
                }else if(_x > (this.width-this.height)*0.9){  
